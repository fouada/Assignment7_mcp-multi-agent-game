...
def assert_match_result(
    result: Dict[str, Any],
    expected_winner: Optional[str] = None,
    expected_loser: Optional[str] = None
) -> None:
    """
...
def assert_event_published(
    ...
    publish_calls = [
        call for call in event_bus_mock.publish.call_args_list
    ]
...
def assert_no_duplicates(items: List[Any], field: Optional[str] = None) -> None:
    """
