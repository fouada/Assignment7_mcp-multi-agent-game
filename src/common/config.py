...
class LLMConfig:
    ...
    model: str | None = None  # Auto-selected based on provider if None
...
class Config:
    ...
    def add_player(self, player_id: str, port: int | None = None) -> ServerConfig:
    ...
    def get_player_config(self, player_id: str) -> ServerConfig | None:
