...
class Message:
    ...
    target_server: Optional[str] = field(compare=False, default=None)
    callback: Optional[asyncio.Future] = field(compare=False, default=None)
...
class MessageQueue:
    ...
    def __init__(
        ...
        # Rate limiting
        self._last_dequeue_time: Optional[datetime] = None
