...
[![Open Source](https://img.shields.io/badge/Open%20Source-100%25-brightgreen?style=for-the-badge)](https://opensource.org)
[![Community](https://img.shields.io/badge/Community-Driven-blue?style=for-the-badge)](README.md)
[![MIT Licensed](https://img.shields.io/badge/License-MIT-yellow?style=for-the-badge)](../../LICENSE)
[![Reusable](https://img.shields.io/badge/Templates-Free%20to%20Use-purple?style=for-the-badge)](REUSABLE_TEMPLATES.md)
...
```mermaid
graph LR
    A[New to<br/>Open Source?] --> B[Start Here!]
    B --> C[Contributing Guide]
    C --> D[Pick an Issue]
    D --> E[Make Your<br/>First PR!]
...
```mermaid
graph TB
    A[Choose Your Path] --> B{What's your goal?}
    
    B -->|Contribute Code| C[Read CONTRIBUTING.md]
    B -->|Start Project| D[Read OPEN_SOURCE_GUIDE.md]
    B -->|Write Docs| E[Read REUSABLE_TEMPLATES.md]
    B -->|Teach/Research| F[Read KNOWLEDGE_TRANSFER_GUIDE.md]
    
    C --> G[Pick Good First Issue]
    D --> H[Choose License]
    E --> I[Use Templates]
    F --> J[Create Tutorial]
    
    G --> K[Make First PR!]
    H --> L[Set Up Governance]
    I --> M[Document Project]
    J --> N[Share Knowledge]
